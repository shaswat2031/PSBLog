...
async function seedDatabase() {
  try {
    ...
    const adminPassword = await bcrypt.hash(
      process.env.ADMIN_PASSWORD || "NoOneCanGuessMe123",
      12
    );
    const adminUser = new User({
      name: process.env.ADMIN_NAME || "Prasad Shaswat",
      email: process.env.ADMIN_EMAIL || "prasadshaswat@gmail.com",
    ...
    const sampleBlogs = [
      {
        ...
        content:
          "This is a sample blog post to demonstrate the MongoDB integration. The blog now uses MongoDB for data storage instead of JSON files.",
      ...
      },
      {
        ...
        content:
          "MongoDB is a powerful NoSQL database that provides flexibility and scalability for modern applications. In this post, we explore the basics of MongoDB integration.",
        excerpt:
          "Learn the basics of MongoDB integration in Node.js applications",
